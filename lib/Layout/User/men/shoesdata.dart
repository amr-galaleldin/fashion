  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocConsumer<UserCubit,UserState>(
        ...
        {
          File? shoesimage = UserCubit.get(context).shoesimage;
          ...
          return Scaffold(
            appBar: AppBar(
              ...
              actions: [
                TextButton(
                  onPressed: () {
                    UserCubit.get(context).UploadshoesPost(description: descriptioncontroller.text,
                ...
                children: [
                  ...
                  if(shoesimage!=null)
                    Stack(
                      ...
                      children: [
                        Image(
                          image: FileImage(File(shoesimage.path))
                          as ImageProvider,
                        ...
                        IconButton(
                          onPressed: () {
                            UserCubit.get(context).removeshoesimage();
                          },
                          icon: CircleAvatar(
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: ()
                      {
                        UserCubit.get(context).GetshoesImage();
                      },
                      child: Container(
                        width:double.infinity,
                        child: TextButton(
