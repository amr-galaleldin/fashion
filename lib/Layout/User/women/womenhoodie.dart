...
class WomenHoodie extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocConsumer<UserCubit,UserState>(
        ...
        {
          File? Hoodieimage = UserCubit.get(context).HoodieWomenimage;
          ...
          return Scaffold(
            appBar: AppBar(
              ...
              actions: [
                TextButton(
                  onPressed: () {
                    UserCubit.get(context).UploadHoodieWomenPost(description: descriptioncontroller.text,
                ...
                children: [
                  ...
                  if(Hoodieimage!=null)
                    Stack(
                      ...
                      children: [
                        ...
                        IconButton(
                          onPressed: () {
                            UserCubit.get(context).removeoodieWomenimage();
                          },
                          icon: CircleAvatar(
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: ()
                      {
                        UserCubit.get(context).GetHoodieWomenImage();
                      },
                      child: Container(
                        width:double.infinity,
                        child: TextButton(
