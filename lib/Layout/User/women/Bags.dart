  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocConsumer<UserCubit,UserState>(
        ...
        {
          File? bagimage = UserCubit.get(context).bagimage;
          ...
          return Scaffold(
            appBar: AppBar(
              ...
              actions: [
                TextButton(
                  onPressed: () {
                    UserCubit.get(context).UploadbagPost(description: descriptioncontroller.text,
                ...
                children: [
                  ...
                  if(bagimage!=null)
                    Stack(
                      ...
                      children: [
                        Image(
                          image: FileImage(File(bagimage.path))
                          as ImageProvider,
                        ...
                        IconButton(
                          onPressed: () {
                            UserCubit.get(context).removebagimage();
                          },
                          icon: CircleAvatar(
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: ()
                      {
                        UserCubit.get(context).GetbagImage();
                      },
                      child: Container(
                        width:double.infinity,
                        child: TextButton(
